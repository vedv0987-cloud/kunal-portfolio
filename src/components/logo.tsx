...
export function Logo({ compact = false }: { compact?: boolean }) {
  return (
    <Link to="/" className="group flex items-center gap-2.5" aria-label="Vedprakash home">
      <span className="grid size-9 place-items-center rounded-lg bg-foreground text-background transition-transform duration-150 group-hover:scale-[0.96]">
        <span className="font-display text-lg font-extrabold leading-none tracking-tight">V</span>
      </span>
